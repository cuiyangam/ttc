...
> Q: 大陆地区 github 低速
> A: git config --global http.https://github.com.proxy socks5://127.0.0.1:1081
...
> Q: macOS10.15.7 无法复制文件原因
> A: 
`sudo mount -uw /`
`killall Finder`

> git push 报403
> macOS 傻瓜似的认为用户在同一网站只用一个账号，注意分析to A to B，你就会发现问题所在
`cuiyangam@cuiyangamdeMacBook-Pro tkc % git push origin main
remote: Permission to cuiyangam/tkc.git denied to cybmws.
fatal: unable to access 'https://github.com/cuiyangam/tkc.git/': The requested URL returned error: 403
`
解决方法，Keychain中删除旧密码
